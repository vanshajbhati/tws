...
class _MemberShipPackageState extends State<MemberShipPackage> {
  ...
  void _trySubmit() async{
    if(selectedValue == null){
      ...
      await Provider.of<ApiManager>(context,listen: false).addMemberShipPackageApi(selectedValue, priceController.text);
      setState(() {
        _isLoad = false;
      });
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: (){
                                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => MemberShipPackageEdit(month:data[index].plan,price:data[index].price,id:data[index].id)));
                                },
                                child: Container(
