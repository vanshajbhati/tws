...
import 'package:tws/apiService/apiResponse/Todo.dart';
        ...
        child: FutureBuilder(
          ...
          builder: (context,snapshots){
            if(snapshots.connectionState == ConnectionState.none)
              ...
              print("ddd"+widget.exerciseSuperset);
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text("Magento",style: TextStyle(
                                  fontSize: 16,
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: ()async{
                                        ...
                                        await Provider.of<ApiManager>(context,listen: false).addToSetApi("reps",snapshots.data['data'][index]['exercise']['id'],controllerReps.text);
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () async{
                                        ...
                                        await Provider.of<ApiManager>(context,listen: false).addToSetTwoControllerApi("weightwithreps",snapshots.data['data'][index]['exercise']['id'],controllerRepsThree.text,controllerWeightThree.text);
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () async{
                                          ...
                                          await Provider.of<ApiManager>(context,listen: false).addToSetApi("km",snapshots.data['data'][index]['exercise']['id'],controllerkm.text);
                                          controllerkm.clear();
                                          setState(() {
                                            isLoadThree = false;
                                          });
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () async{
                                            ...
                                            await Provider.of<ApiManager>(context,listen: false).addToSetApi("time",snapshots.data['data'][index]['exercise']['id'],controllerTime.text);
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () async{
                                              ...
                                              await Provider.of<ApiManager>(context,listen: false).addToSetTwoControllerApi("level",snapshots.data['data'][index]['exercise']['id'],controllerLevelFive.text,controllerTimesFive.text);
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () async{
                                                ...
                                                await Provider.of<ApiManager>(context,listen: false).addToSetApi("breath",snapshots.data['data'][index]['exercise']['id'],controllerBreath.text);
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                onTap: () async{
                                                  ...
                                                  await Provider.of<ApiManager>(context,listen: false).addToSetTwoControllerApi("breathwithreps",snapshots.data['data'][index]['exercise']['id'],controllerRepsSeven.text,controllerbreathSeven.text);
