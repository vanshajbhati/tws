...
class _AddFoodState extends State<AddFood> {
  ...
  void _trySubmit()async{
    if(foodController.text.isEmpty){
      ...
      await Provider.of<ApiManager>(context,listen: false).addFoodApi(foodController.text, proteinController.text, carbController.text, fatController.text,widget.mealId);
      setState(() {
        _isLoad = false;
      });
    }
    ...
    return new Container(
      ...
      child: DropdownSearch(
        ...
        onChanged: (Data data) {
          ...
          Provider.of<ApiManager>(context,listen: false).addFoodToMealApi(data.id, widget.mealId);
