...
class APIRepository {
  ...
  Future createBlogApi(String title,String description,File file) async{
    var key = await SharedPrefManager.getPrefrenceString(AppConstant.KEY);
    FormData formData = new FormData.fromMap({
      "key": key,
      "title": title,
  ...
  Future addTosetApi(String tag,id,String time) async{
    FormData formData;
    var key = await SharedPrefManager.getPrefrenceString(AppConstant.KEY);
    if(tag == "time"){
  ...
  Future addTosettwoControllerApi(String tag,id,String level,String time) async{
    FormData formData;
    var key = await SharedPrefManager.getPrefrenceString(AppConstant.KEY);
    if(tag == "level"){
      formData = new FormData.fromMap({
